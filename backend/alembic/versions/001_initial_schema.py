...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("rating", sa.Numeric(2, 1), server_default="4.9"),
    ...
    imgs_neck = [
        ...
        {"url": "https://images.unsplash.com/photo-1515562141202-7a88fb084127?w=800&q=80", "alt": "القلادة مُرتdaة", "sort_order": 2},
        {"url": "https://images.unsplash.com/photo-1543294001-fd4a5d7a84a7?w=800&q=80", "alt": "التغليف", "sort_order": 3},
    ]
    imgs_ring2 = [
